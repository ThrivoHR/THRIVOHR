...
const columns = ["ID", "Full Name", "Addition Date", "Reason"];

const employees: Employee[] = [
  {
    id: "EMP001",
    fullName: "John Doe",
    additionDate: "2023-05-10",
    reason: "Training upgrade",
  },
  {
    id: "EMP002",
    fullName: "Jane Doe",
    additionDate: "2023-04-15",
    reason: "New skill acquisition",
  },
  {
    id: "EMP003",
    fullName: "Bob Smith",
    additionDate: "2023-06-20",
  ...
  return (
    <div>
      ...
      <div className="flex justify-end items-center py-3 space-x-2">
          <Button>Add new addition</Button>
      ...
      <div className="border rounded-lg w-full h-[80vh] flex flex-col">
        <DataTable
          ...
          data={employees.map((employee) => ({
            ...
            "Addition Date": employee.additionDate,
                  ...
                  <form className="grid grid-cols-1 gap-4">
                    ...
                    <div className="flex flex-col">
                      ...
                      <Input
                        type="text"
                        name="additionalDate"
                        value={selectedEmployee.additionDate}
                        onChange={handleInputChange}
                        className="p-2 border rounded"
                      />
                    </div>
