...
const columns = ["ID", "Full Name", "Reason of deduction", "Deduction"];

const employees: Employee[] = [
  {
    id: "EMP001",
    fullName: "John Doe",
    reasonOfDeduction: "Late",
    deductNumber: 2000,
  },
  {
    id: "EMP002",
      ...
      <div className="border rounded-lg w-full h-[80vh] flex flex-col">
        <DataTable
          ...
          data={employees.map((employee) => ({
            ...
            "Reason of deduction": employee.reasonOfDeduction,
            Deduction: employee.deductNumber,
          }))}
                  ...
                  <form className="grid grid-cols-1 gap-4">
                    ...
                    <div className="flex flex-col">
                      ...
                      <Input
                        type="text"
                        name="joinDate"
                        value={selectedEmployee.reasonOfDeduction}
                        onChange={handleInputChange}
                        className="p-2 border rounded"
                      />
                    </div>
                    <div className="flex flex-col">
                      ...
                      <Input
                        type="text"
                        name="joinDate"
                        value={selectedEmployee.deductNumber}
                        onChange={handleInputChange}
                        className="p-2 border rounded"
                      />
                    </div>
